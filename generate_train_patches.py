## https://github.com/megvii-research/DVN/blob/main/generate_train_patches.py
...
parser.add_argument('--src_dir', default='./Dataset/DVD/train_raw', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='./Dataset/DVD/train',type=str, help='Directory for image patches')
